...
if [ $USE_SGLANG -eq 1 ]; then
    pip install "sglang[all]==0.4.6.post1" --no-cache-dir --find-links https://flashinfer.ai/whl/cu124/torch2.6/flashinfer-python -i https://pypi.tuna.tsinghua.edu.cn/simple && pip install torch-memory-saver --no-cache-dir -i https://pypi.tuna.tsinghua.edu.cn/simple
fi
...
pip install "transformers[hf_xet]>=4.51.0" accelerate datasets peft hf-transfer \
    ...
    pytest py-spy pyext pre-commit ruff -i https://pypi.tuna.tsinghua.edu.cn/simple
...
if [ $USE_MEGATRON -eq 1 ]; then
    ...
    NVTE_FRAMEWORK=pytorch pip3 install --no-deps git+https://github.com/NVIDIA/TransformerEngine.git@v2.2 -i https://pypi.tuna.tsinghua.edu.cn/simple
    pip3 install --no-deps git+https://github.com/NVIDIA/Megatron-LM.git@core_v0.12.0rc3 -i https://pypi.tuna.tsinghua.edu.cn/simple
fi
