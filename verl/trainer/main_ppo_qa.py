...
from verl.trainer.ppo.ray_trainer_qa import RayPPOTrainer
...
class TaskRunner:
    def run(self, config):
        ...
        from verl.trainer.ppo.ray_trainer_qa import ResourcePoolManager, Role
...
class RewardManager():
    ...
    def get_rewards(self, data: DataProto):
        ...
        return metric_tensor_f1, metrics_tensor_all
